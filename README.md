...
### 平面结构（4个）
5. **三氟化硼 (BF₃)** - 平面三角形, sp²杂化
6. **甲醛 (CH₂O)** - 平面三角形, sp²杂化
7. **乙烯 (C₂H₄)** - 平面, sp²杂化
8. **苯 (C₆H₆)** - 平面正六边形, sp²杂化, 大π键

### 直线形与V形（4个）
9. **乙炔 (C₂H₂)** - 直线形, sp杂化
10. **二氯化铍 (BeCl₂)** - 直线形, sp杂化
11. **二氧化硫 (SO₂)** - V形, sp²杂化, 1对孤对电子
12. **硫化氢 (H₂S)** - V形, sp³杂化, 2对孤对电子

### 复杂几何构型（5个）
13. **五氯化磷 (PCl₅)** - 三角双锥, sp³d杂化
14. **六氟化硫 (SF₆)** - 正八面体, sp³d²杂化
15. **三氟化氯 (ClF₃)** - T形, sp³d杂化, 2对孤对电子
16. **四氟化氙 (XeF₄)** - 平面四方形, sp³d²杂化, 2对孤对电子
17. **三氧化硫 (SO₃)** - 平面三角形, sp²杂化

### 其他常见分子（3个）
18. **磷化氢 (PH₃)** - 三角锥, sp³杂化, 1对孤对电子
19. **氯甲烷 (CH₃Cl)** - 四面体, sp³杂化
20. **甲醇 (CH₃OH)** - 四面体+V形, sp³杂化
